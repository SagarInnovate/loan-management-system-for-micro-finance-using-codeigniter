                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control full_name" placeholder="Full Name" name="fullname" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <!-- <label class="bmd-label-floating">Current Address</label> -->
                                                                    <input type="text" placeholder="Current Address" class="form-control address" name="address" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="email" placeholder="Email" class="form-control email" name="email" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <!-- <label class="bmd-label-floating">SIM1-Contact No</label> -->
                                                                    <input type="text" placeholder="SIM1-Contact No" class="form-control sim1" name="sim1" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <!-- <label class="bmd-label-floating">SIM2-Contact No</label> -->
                                                                    <input type="text" placeholder="SIM2-Contact No" class="form-control sim2" name="sim2" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                        ...
                                                        <div class="row bs">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control street1" name="street" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row bs">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control province1" name="state" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row c-add" style="display: none" >
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <!-- <label class="bmd-label-floating">Current Address</label> -->
                                                                    <input type="text" class="form-control address" placeholder="Current Address" id="c_address" name="address" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
