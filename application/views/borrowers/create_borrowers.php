                        ...
                        <div class="col-md-12">
                            ...
                            <div class="tab-content tab-space">
                                ...
                                <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form id="form-register" enctype="mutlipart/form-data"  method="POST">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="card">
                                                                            <div class="card-body">
                                                                                ...
                                                                                <div id="aadharSpinner" class="spinner" style="display: none;">Loading...
                                                                                </div>

                                                                                <b>
                                                                                    <div id="aadharUploadMsg" style="color:green"></div>
                                                                                </b> <!-- Upload message container -->
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="card">
                                                                            <div class="card-body">
                                                                                ...
                                                                                <div id="panSpinner" class="spinner" style="display: none;">Loading...
                                                                                </div>
                                                                                ...
                                                                                <b>
                                                                                    <div id="panUploadMsg" style="color:green"></div>
                                                                                </b> <!-- Upload message container -->
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="card">
                                                                            <div class="card-body">
                                                                                ...
                                                                                <div id="electricitySpinner" class="spinner" style="display: none;">Loading...
                                                                                </div>


                                                                                <b>
                                                                                    <div id="electricityUploadMsg" style="color:green"></div>
                                                                                </b> <!-- Upload message container -->
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="card">
                                                                            <div class="card-body">
                                                                                ...
                                                                                <div id="applicationSpinner" class="spinner" style="display: none;">Loading...
                                                                                </div>

                                                                                <b>
                                                                                    <div id="applicationUploadMsg" style="color:green"></div>
                                                                                </b> <!-- Upload message container -->
                                                                ...
                                                                <div class="row mt-1">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label class="bmd-label-floating">Write
                                                                                    something about
                                                                                    the client.. </label>
