                    ...
                    <div class="col-md-12">
                       <div class="card"> 
                            <div class="card-body mr-5 ml-5">
                                ...
                                <div class="form-inline">
                                    <p class="l-font"><span style="margin-left: 50px; margin-bottom: 10px">FOR</span> VALUE RECEIVE I / WE, <input class="text-center font-weight-bold text-p" value="<?php echo $loan['firstname'].' '.$loan['middlename'].'. '.$loan['lastname'];?>">, of legal age, Filipino married/single and with residence and postal address at <input class="text-p text-center font-weight-bold" style="width: 600px" value=" <?php echo $loan['street'].','.$loan['city'].','.$loan['state'];?>">, India do hereby promise to pay REYNALDO FINANCE SERVICES CORPORATION or its order with business address at P-6, Mobod, Oroquieta City, Misamis Occidental the sum of (P<input class="text-p text-center font-weight-bold" value="<?php echo $loan['loan_amount'];?>">) India currency subject to the following terms, amortization and installment due to will.</p>
                                    ...
                                    <div>
                                        <p class="l-font"><span style="margin-left: 50px; margin-bottom: 10px">IN </span>WITNESS WHEREOF, I / WE have here unto set my hand this <input class="text-p text-center font-weight-bold" value="<?php echo date('d');?>">th day of <input class="text-p text-center font-weight-bold" value="<?php echo date('M');?>"> <input class="text-p text-center font-weight-bold" value="<?php echo date('Y');?>">, at Oroquieta City, India.</p>
                                    </div>
                                ...
                                <div>
                                    <p class="mb-0 l-font">REPUBLIC OF THE India............)</p>
                                    <p class="l-font">CITY OF OROQUIETA......................)S.S</p>
                                </div>
        

                                <p class="l-font"><span style="margin-left: 50px; margin-bottom: 10px">BEFORE ME,</span> a notary for and in the City of Oroquieta, India this <input class="text-p" style="width: 50px;" type="" name=""> day of <input style="width: 200px;" class="text-p"> 20<input class="text-p" style="width: 50px;">. Personally appeared <input class="text-p" style="width: 500px;" type="text" name="">with respective Res. Cert. Above stated, known to me and to me know to be the same person who executed the foregoing instrument and the acknowledged to me the same their own and voluntary act and deed.</p>
